    ...
    "ns-hugo:/home/runner/work/kamrad/kamrad/assets/js/components/pong/Pong.tsx"() {
      ...
      Pong = () => {
        ...
        const handleOnClick = (event) => {
          ...
          ping().then((pong2) => setPong(pong2)).catch((error) => console.log(error)).finally(() => setLoading(false));
        };
        return /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("button", {
          style: { "textAlign": "center", "padding": "11px 5px", "borderRadius": "50%", "cursor": "help", "margin": "0 30px 0 0" },
          onClick: handleOnClick
        }, "Ping"), loading ? /* @__PURE__ */ import_react.default.createElement("p", null, "common! click it!...") : /* @__PURE__ */ import_react.default.createElement("p", {
          style: { "display": "inline-block", "borderRadius": "50%", "textTransform": "uppercase", "textAlign": "center", "fontSize": "60px", "background": "rebeccapurple", "padding": "80px 40px" }
        }, pong, "!"));
      };
    }
  });

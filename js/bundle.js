(() => {
  ...
  var setAuthToken, broadcastEventHandlers, authBroadcastChannel;
  ...
  var init_Login = __esm({
    "ns-hugo:/home/runner/work/kamrad/kamrad/assets/js/components/login/Login.tsx"() {
      ...
      LoginForm = ({
        ...
        return /* @__PURE__ */ import_react.default.createElement("form", null, /* @__PURE__ */ import_react.default.createElement("input", {
          type: "password",
          onChange,
          value: token
  ...
  var containerId = "loginForm";
  document.addEventListener("DOMContentLoaded", function() {
    var container = document.getElementById(containerId);
    container && ReactDOM.render(/* @__PURE__ */ React2.createElement(_Login.Login), container);
  });
})();
/*
object-assign
...
(() => {
  ...
  // ns-hugo:/home/runner/work/kamrad/kamrad/assets/js/auth/authHelper.ts
  var clearAuthToken, broadcastEventHandlers, authBroadcastChannel;
  var init_authHelper = __esm({
    "ns-hugo:/home/runner/work/kamrad/kamrad/assets/js/auth/authHelper.ts"() {
      init_types();
  ...
  var containerId = "logoutButton";
  document.addEventListener("DOMContentLoaded", function() {
    var container = document.getElementById(containerId);
    ReactDOM.render(/* @__PURE__ */ React2.createElement(_Logout.LogoutButton), container);
  });
})();
/*
object-assign
